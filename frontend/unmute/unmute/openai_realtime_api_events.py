...
class ConversationItemInputText(BaseEvent[Literal["conversation.item.input_text"]]):
    text: str
    patientProfile: dict | None = None


# Add support for llama.extra_info messages from the frontend
class LlamaExtraInfo(BaseEvent[Literal["llama.extra_info"]]):
    extra_info: str
...
ClientEvent = Union[
    ...
    ConversationItemInputText,
    LlamaExtraInfo,  # Now supported
]
